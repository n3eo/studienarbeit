...
CREATE TABLE `Buch` (
  ...
  `Titel` TEXT NOT NULL,
  `Untertitel` VARCHAR(500) NULL DEFAULT NULL,
...
CREATE TABLE `AutorBuchZuord` (
  `AutorBuchZuordId` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `AutorId` INTEGER(11) NOT NULL,
  `ISBN` VARCHAR(17) NOT NULL,
  PRIMARY KEY (`AutorBuchZuordId`)
) CHARACTER SET=utf8mb4;
...
CREATE TABLE `Verlag` (
  ...
  `Kurzname` VARCHAR(150) NULL DEFAULT NULL,
...
CREATE TABLE `Video` (
  ...
  `NichtTextMedienId` Integer(13) NOT NULL,
  `Sprache` VARCHAR(20) NULL DEFAULT NULL,
  PRIMARY KEY (`VideoId`)
) CHARACTER SET=utf8mb4;
...
CREATE TABLE `MediumWortZuord` (
  `MediumWortId` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `MediumId` VARCHAR(17) NOT NULL,
  `Wort` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`MediumWortId`)
) CHARACTER SET=utf8mb4;
...
CREATE TABLE `NichtTextMedien` (
  `NichtTextMedienId` Integer(13) NOT NULL AUTO_INCREMENT,
  `Titel` TEXT NOT NULL,
  `Untertitel` VARCHAR(500) NULL DEFAULT NULL,
  `Erscheinungsjahr` SMALLINT(4) NULL DEFAULT NULL,
