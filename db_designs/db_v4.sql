...
ALTER TABLE `Ausleihe` ADD FOREIGN KEY (MediumId) REFERENCES `Ebooks` (`ISBN`);
ALTER TABLE `Ausleihe` ADD FOREIGN KEY (MediumId) REFERENCES `Hoerbuch` (`ISBN`);
ALTER TABLE `Ausleihe` ADD FOREIGN KEY (MediumId) REFERENCES `NichtTextMedien` (`NichtTextMedienId`);
...
ALTER TABLE `MediumWortZuord` ADD FOREIGN KEY (MediumId) REFERENCES `Ebooks` (`ISBN`);
